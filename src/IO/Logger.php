...
class Logger
{
    ...
    /**
     * set the log folder
     * @param string $folder - path folder of log
    */
    public static function setFolderLog($folder)
    {
        static::$log_folder = $folder;
    }
    /**
